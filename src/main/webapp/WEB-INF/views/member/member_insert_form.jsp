	...
	function resultFn(){
		if(xhr.readyState == 4 && xhr.status == 200){
			...
			if(json[0].result == 'no'){
				...
				alert("사용 가능한 계정입니다.")
				b_check_e_email = true
			}
		}
	}
	
	function check(){
		b_check_e_email = false
	}
</script>
</head>
<body>
		...
		<table border="1" align="center">
			...
			<tr>
				...
				<td>
					...
					<input type="button" value="중복체크" onclick="check_e_email()">
				</td>
			</tr>
			<tr>
				<th>이름</th>
